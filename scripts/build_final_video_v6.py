#!/usr/bin/env python3
"""V6 合成：读取录制时间轴 JSON，配音精确对齐镜头（无静默空洞）。输出 V6 新文件。

用法: /usr/bin/python3 build_final_video_v6.py <源mp4> [timeline.json]
"""
...
OUT_PLAIN = OUT_DIR / "智能物资数据管理系统-演示视频-V6-纯视频版.mp4"
OUT_VOICE = OUT_DIR / "智能物资数据管理系统-演示视频-V6-配音版.mp4"
